 ...
 */
  public static int Mtc_ConfJoin(int iConfId, Object zCookie, String pcUri) {
    return MtcConfJNI.Mtc_ConfJoin(iConfId, zCookie, pcUri);
  }
...
/**
 * @brief MTC conference enable/disable dynamic reset encoder to change aspect.
 *
 * @param [in] iConfId The ID of conference.
