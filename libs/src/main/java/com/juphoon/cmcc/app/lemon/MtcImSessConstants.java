...
public interface MtcImSessConstants {
  ...
  // EN_MTC_IM_SESS_REQ_ITYPE 
  public final static int EN_MTC_IM_SESS_IMDN_UNKNOWN = 0; /**< @brief unknown message */
  public final static int EN_MTC_IM_SESS_IMDN_REG = EN_MTC_IM_SESS_IMDN_UNKNOWN + 1; /**< @brief regular message */
  public final static int EN_MTC_IM_SESS_IMDN_DELI = EN_MTC_IM_SESS_IMDN_REG + 1; /**< @brief message with delivery notification request */
  public final static int EN_MTC_IM_SESS_IMDN_DISP = EN_MTC_IM_SESS_IMDN_DELI + 1; /**< @brief message with display notification request */
  public final static int EN_MTC_IM_SESS_IMDN_BOTH = EN_MTC_IM_SESS_IMDN_DISP + 1; /**< @brief message with delivery & display notification request */
