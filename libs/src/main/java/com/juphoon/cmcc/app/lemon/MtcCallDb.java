 ...
 */
  public static int Mtc_CallDbGetSessTmrInfo(MtcNumber piType, MtcNumber piTmrLen, MtcNumber piMinTmrLen) {
    return MtcCallDbJNI.Mtc_CallDbGetSessTmrInfo(piType, piTmrLen, piMinTmrLen);
  }
 ...
 * @see @ref MtcCallDb::Mtc_CallDbGetSymNego
 */
  public static int Mtc_CallDbSetSessTmrInfo(int iType, int iTmrLen, int iMinTmrLen) {
    return MtcCallDbJNI.Mtc_CallDbSetSessTmrInfo(iType, iTmrLen, iMinTmrLen);
  }
...
/**
 * @brief Get session heartbeat timer information.
 *
 * @param [out] piTmrLen Heartbeat timer length.
 *
 * @retval true Get heartbeat timer information successfully.
 * @retval false Get heartbeat timer information failed.
 *
 * @see @ref MtcCallDb::Mtc_CallDbSetSessHearBeatTmrLen
 */
  public static int Mtc_CallDbGetSessHearBeatTmrLen(MtcNumber piTmrLen) {
    return MtcCallDbJNI.Mtc_CallDbGetSessHearBeatTmrLen(piTmrLen);
  }

/**
 * @brief Set heartbeat timer information.
 *
 * @param [in] iTmrLen Heartbeat timer length.
 *
 * @retval MtcCommonConstants::ZOK Set the heartbeat timer successfully.
 * @retval MtcCommonConstants::ZFAILED Set the heartbeat timer failed.
 *
 * @see @ref MtcCallDb::Mtc_CallDbGetSessHearBeatTmrLen
 */
  public static int Mtc_CallDbSetSessHearBeatTmrLen(int iTmrLen) {
    return MtcCallDbJNI.Mtc_CallDbSetSessHearBeatTmrLen(iTmrLen);
  }
