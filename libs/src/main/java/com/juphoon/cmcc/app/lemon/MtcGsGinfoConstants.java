...
public interface MtcGsGinfoConstants {
  ...
  // EN_MTC_GS_GINFO_IMDN_TYPE 
  public final static int EN_MTC_GS_GINFO_IMDN_UNKNOWN = 0; /**< @brief unknown imdn type */
  public final static int EN_MTC_GS_GINFO_IMDN_REG = EN_MTC_GS_GINFO_IMDN_UNKNOWN + 1; /**< @brief regular location */
  public final static int EN_MTC_GS_GINFO_IMDN_DELI = EN_MTC_GS_GINFO_IMDN_REG + 1; /**< @brief location with delivery notification request */
  public final static int EN_MTC_GS_GINFO_IMDN_DISP = EN_MTC_GS_GINFO_IMDN_DELI + 1; /**< @brief location with display notification request */
