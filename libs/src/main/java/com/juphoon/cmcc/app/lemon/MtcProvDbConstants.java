...
public interface MtcProvDbConstants {
  ...
  // EN_MTC_PROV_TMNL_TYPE 
  public final static int EN_MTC_PROV_TMNL_APP = 0; /**< @brief app terminal type */
  public final static int EN_MTC_PROV_TMNL_NATIVE = EN_MTC_PROV_TMNL_APP + 1; /**< @brief native terminal type */
  public final static int EN_MTC_PROV_TMNL_FETION_PC = EN_MTC_PROV_TMNL_NATIVE + 1; /**< @brief fetion pc terminal type */
  public final static int EN_MTC_PROV_TMNL_FETION_MOBILE = EN_MTC_PROV_TMNL_FETION_PC + 1; /**< @brief fetion mobile terminal type */
