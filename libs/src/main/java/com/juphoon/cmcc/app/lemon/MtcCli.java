 ...
 *
 * @retval MtcCommonConstants::ZOK Initialize client resource successfully.
 * @retval MTC_LCS_ERR_NEED_ACT_LICSEN, Initialize client resource failed, 
 * you should call Mtc_lcsActivate activate licenser .
 * &retval MtcCommonConstants::ZFAILED, Initialize client resource failed.
 ...
 *
 * @retval MtcCommonConstants::ZOK Open a account successfully.
 * @retval MtcCommonConstants::ZFAILED Initialize a account failed.
 *
 ...
 *
 * @retval MtcCommonConstants::ZOK Start client service successfully.
 * @retval MtcCommonConstants::ZFAILED Start client service failed.
 *
 ...
 * 
 * @param [in] iAccNetType The access network type MTC_ANET_MOBILE...
 ...
 *
 * @retval MtcCommonConstants::ZOK Client is logining.
 * @retval MtcCommonConstants::ZFAILED Client login failed.
 *
 ...
 * @see @ref MtcCli::Mtc_CliLogout
 */
  public static int Mtc_CliRelogin(int iAccNetType, String pcAccNetIp) {
    return MtcCliJNI.Mtc_CliRelogin(iAccNetType, pcAccNetIp);
  }
 ...
 * @see @ref MtcCli::Mtc_CliLogout
 */
  public static int Mtc_CliEnterAkaRsp(int iRegId, String pcRsp, String pcCk, String pcIk, String pcAuts) {
    return MtcCliJNI.Mtc_CliEnterAkaRsp(iRegId, pcRsp, pcCk, pcIk, pcAuts);
  }
 ...
 * @see @ref MtcCli::Mtc_CliLogout
 */
  public static int Mtc_CliEnterDgstPwd(int iRegId, String pcPwd) {
    return MtcCliJNI.Mtc_CliEnterDgstPwd(iRegId, pcPwd);
  }
 ...
 *
 * @retval MtcCommonConstants::ZOK Client send re-REGISTER ok.
 * @retval MtcCommonConstants::ZFAILED Client send re-REGISTER failed.
 *
 ...
 *
 * @retval MtcCommonConstants::ZOK Client is logouting.
 * @retval MtcCommonConstants::ZFAILED Client logout failed.
 *
 ...
 *
 * @retval MtcCommonConstants::ZOK Send info ok.
 * @retval MtcCommonConstants::ZFAILED Send info failed.
 */
  public static int Mtc_CliInfo(String pcType, String pcInfo) {
    return MtcCliJNI.Mtc_CliInfo(pcType, pcInfo);
  }
 ...
 *
 * @retval MtcCommonConstants::ZOK Drive Service successfully.
 * @retval MtcCommonConstants::ZFAILED Drive Service failed.
 *
 */
  public static int Mtc_CliDrive(long zEvntId) {
 ...
 *
 * @retval MtcCommonConstants::ZOK successfully.
 */
  public static int Mtc_CliDetLclIpv6(MtcNumber pucIpv6) {
    return MtcCliJNI.Mtc_CliDetLclIpv6(pucIpv6);
  }

/**
 * @brief Detect and set the use ip address type.
 *
 * @retval MtcCommonConstants::ZOK detect and set the use ip address type successfully.
 */
 ...
 *
 * @param [in] iType The device id  type MtcCliConstants::EN_MTC_DEVICE_ID_SERIAL.
 *
 * @return Device Id string.
 */
  public static String Mtc_CliGetDevIdX(int iType) {
    return MtcCliJNI.Mtc_CliGetDevIdX(iType);
  }

/**
 * @brief Download mmp file.
 *
 * @retval MtcCommonConstants::ZOK Download mmp file successfully.
 * @retval MtcCommonConstants::ZFAILED Download mmp file failed.
 */
 ...
 *
 * @retval MtcCommonConstants::ZOK Network unavailable successfully.
 * @retval MtcCommonConstants::ZFAILED Network unavailable failed.
 */
 ...
 * @brief Check App.
 *
 * @retval MtcCommonConstants::ZOK Check App successfully.
 * @retval MtcCommonConstants::ZFAILED Check App failed.
 */
 ...
 * 
 * @param [in] iNetType The new network type MtcCliConstants::EN_MTC_DEVICE_ID_SERIAL.
 *
 */
  public static int Mtc_CliCallCbNetChanged(int iNetType) {
    return MtcCliJNI.Mtc_CliCallCbNetChanged(iNetType);
  }
