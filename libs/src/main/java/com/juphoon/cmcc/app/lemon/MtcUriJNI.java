...
public class MtcUriJNI {
  ...
  public final static native boolean Mtc_UriIsValid(String jarg1);
  public final static native String Mtc_UriFormat(String jarg1, String jarg2, boolean jarg3);
  public final static native String Mtc_UriFormatX(String jarg1, boolean jarg2);
  public final static native String Mtc_UriFormatTelUri(String jarg1);
  public final static native String Mtc_UriFormatNat(String jarg1);
  public final static native String Mtc_UriFormatInt(String jarg1);
  public final static native String Mtc_UriGetName(String jarg1, int jarg2);
  public final static native String Mtc_UriGetUserPart(String jarg1);
  public final static native String Mtc_UriGetHostPart(String jarg1);
}
