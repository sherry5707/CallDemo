...
public class MtcImImdnJNI {
  ...
  public final static native int Mtc_ImdnSendDisp(int jarg1, String jarg2, String jarg3, String jarg4, String jarg5);
  public final static native int Mtc_ImdnSendDeli(int jarg1, String jarg2, String jarg3, String jarg4, String jarg5);
  public final static native int Mtc_ImdnSendBurn(String jarg1, String jarg2, String jarg3, String jarg4);
  public final static native String Mtc_ImdnGetIMsgId(int jarg1);
  public final static native int Mtc_ImdnGetPartp(int jarg1, MtcString jarg2, MtcString jarg3);
}
