...
/**
 * @brief Get IM imdn delivery succeed report support.
 *
 * @retval true Indicates delivery succeed report is support.
 * @retval false Indicates delivery succeed report is support.
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnDeliSuccRptSupt
 */
  public static boolean Mtc_ImDbGetImdnDeliSuccRptSupt() {
    return MtcImDbJNI.Mtc_ImDbGetImdnDeliSuccRptSupt();
  }

/**
 * @brief Get IM imdn delivery failed report support.
 *
 * @retval true Indicates delivery failed report is support.
 * @retval false Indicates delivery failed report is support.
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnDeliSuccRptSupt
 */
  public static boolean Mtc_ImDbGetImdnDeliFailRptSupt() {
    return MtcImDbJNI.Mtc_ImDbGetImdnDeliFailRptSupt();
  }

/**
 * @brief Get IM imdn delivery forwarded report support.
 *
 * @retval true Indicates delivery forwarded report is support.
 * @retval false Indicates delivery forwarded report is support.
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnDeliForwardRptSupt
 */
  public static boolean Mtc_ImDbGetImdnDeliForwardRptSupt() {
    return MtcImDbJNI.Mtc_ImDbGetImdnDeliForwardRptSupt();
  }

/**
 * @brief Get IM imdn send delivery request enable.
 *
 * @retval true Send delivery request is enable.
 * @retval false Send delivery request is disable.
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnSendDeliReqEnable
 */
  public static boolean Mtc_ImDbGetImdnSendDeliReqEnable() {
    return MtcImDbJNI.Mtc_ImDbGetImdnSendDeliReqEnable();
  }
 ...
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnSendDispReqEnable
 */
  public static boolean Mtc_ImDbGetImdnSendDispReqEnable() {
    return MtcImDbJNI.Mtc_ImDbGetImdnSendDispReqEnable();
  }
 ...
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnSendDeliRspEnable
 */
  public static boolean Mtc_ImDbGetImdnSendDeliRspEnable() {
    return MtcImDbJNI.Mtc_ImDbGetImdnSendDeliRspEnable();
  }
 ...
 *
 * @see @ref MtcImDb::Mtc_ImDbSetImdnSendDispRspEnable
 */
  public static boolean Mtc_ImDbGetImdnSendDispRspEnable() {
    return MtcImDbJNI.Mtc_ImDbGetImdnSendDispRspEnable();
  }
...
/**
 * @brief Set IM imdn delivery succeed report support.
 *
 * @param [in] bEnable delivery succeed report support.
 *
 * @retval MtcCommonConstants::ZOK Set delivery succeed report support successfully.
 * @retval MtcCommonConstants::ZFAILED Set delivery succeed report support failed.
 *
 * @see @ref MtcImDb::Mtc_ImDbGetImdnDeliSuccRptSupt
*/
  public static int Mtc_ImDbSetImdnDeliSuccRptSupt(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnDeliSuccRptSupt(bEnable);
  }

/**
 * @brief Set IM imdn delivery failed report support.
 *
 * @param [in] bEnable delivery failed report support.
 *
 * @retval MtcCommonConstants::ZOK Set delivery failed report support successfully.
 * @retval MtcCommonConstants::ZFAILED Set delivery failed report support failed.
 *
 * @see @ref MtcImDb::Mtc_ImDbGetImdnDeliFailRptSupt
*/
  public static int Mtc_ImDbSetImdnDeliFailRptSupt(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnDeliFailRptSupt(bEnable);
  }

/**
 * @brief Set IM imdn delivery forwarded report support.
 *
 * @param [in] bEnable delivery forwarded report support.
 *
 * @retval MtcCommonConstants::ZOK Set delivery forwarded report support successfully.
 * @retval MtcCommonConstants::ZFAILED Set delivery forwarded report support failed.
 *
 * @see @ref MtcImDb::Mtc_ImDbGetImdnDeliForwardRptSupt
*/
  public static int Mtc_ImDbSetImdnDeliForwardRptSupt(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnDeliForwardRptSupt(bEnable);
  }

/**
 * @brief Set IM imdn send delivery request enable.
 *
 * @param [in] bEnable send delivery request enable.
 *
 * @retval MtcCommonConstants::ZOK Set send delivery request enable successfully.
 * @retval MtcCommonConstants::ZFAILED Set send delivery request enable failed.
 *
 * @see @ref MtcImDb::Mtc_ImDbGetImdnSendDeliReqEnable
 */
  public static int Mtc_ImDbSetImdnSendDeliReqEnable(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnSendDeliReqEnable(bEnable);
  }
 ...
 *
 * @see @ref MtcImDb::Mtc_ImDbGetImdnSendDispReqEnable
 */
  public static int Mtc_ImDbSetImdnSendDispReqEnable(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnSendDispReqEnable(bEnable);
  }
 ...
 * @see @ref MtcImDb::Mtc_ImDbGetImdnSendDeliReqEnable
 */
  public static int Mtc_ImDbSetImdnSendDeliRspEnable(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnSendDeliRspEnable(bEnable);
  }
 ...
 *
 * @see @ref MtcImDb::Mtc_ImDbGetImdnSendDispRspEnable
 */
  public static int Mtc_ImDbSetImdnSendDispRspEnable(boolean bEnable) {
    return MtcImDbJNI.Mtc_ImDbSetImdnSendDispRspEnable(bEnable);
  }
