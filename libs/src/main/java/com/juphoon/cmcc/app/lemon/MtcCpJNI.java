...
public class MtcCpJNI {
  ...
  public final static native int Mtc_Cp(int jarg1, String jarg2);
  public final static native int Mtc_CpReCfg(int jarg1);
  public final static native int Mtc_CpAct(int jarg1, int jarg2);
  public final static native int Mtc_CpValidSMS(String jarg1);
  public final static native int Mtc_CpPromptMSISDN(int jarg1, String jarg2);
  public final static native int Mtc_CpPromptOTP(int jarg1, String jarg2);
  public final static native int Mtc_CpPromptToken(int jarg1, String jarg2);
  public final static native int Mtc_CpEUCRAct(int jarg1, int jarg2, String jarg3);
  public final static native int Mtc_CpAD();
  public final static native int Mtc_CpADWithOTP(String jarg1);
  public final static native int Mtc_CpADPromptOTP(int jarg1, String jarg2);
  public final static native int Mtc_CpADPromptPIN(int jarg1, String jarg2);
}
