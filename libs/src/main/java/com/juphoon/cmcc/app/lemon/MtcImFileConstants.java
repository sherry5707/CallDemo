...
public interface MtcImFileConstants {
  ...
  // EN_MTC_IM_FILE_IMDN_TYPE 
  public final static int EN_MTC_IM_FILE_IMDN_UNKNOWN = 0; /**< @brief unknown imdn type */
  public final static int EN_MTC_IM_FILE_IMDN_REG = EN_MTC_IM_FILE_IMDN_UNKNOWN + 1; /**< @brief regular file transfer */
  public final static int EN_MTC_IM_FILE_IMDN_DELI = EN_MTC_IM_FILE_IMDN_REG + 1; /**< @brief file transfer with delivery notification request */
  public final static int EN_MTC_IM_FILE_IMDN_BURN = EN_MTC_IM_FILE_IMDN_DELI + 1; /**< @brief file transfer with burn after reading notification request */
