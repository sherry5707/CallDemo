...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, JRClientCallback,JRMessageCallback {
...
//                showDialog();
    ...
    private void initSDK() {
        ...
        JRClient.getInstance().startInitWithAppkey(this, "db2dec279345043a1d2605cab29c28a1");
    }
